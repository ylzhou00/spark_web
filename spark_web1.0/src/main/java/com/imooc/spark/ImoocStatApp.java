...
//
//        List<CourseClickCount> list = courseClickCountDAO.query("20190401");
...
//    }
    ...
    @ResponseBody
    public List<CourseClickCount> courseClickCount(@RequestBody(required=true) Map<String,Object>map) throws Exception {
    ...
    public ModelAndView echarts(){
        return new ModelAndView("echarts2");
    }
